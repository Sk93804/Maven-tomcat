    ...
    stages {
        ...
        stage('Start SonarQube'){
            ...
            steps{
                ...
                docker run -d --name sonarQube  -p 9000:9000 -e SONAR_ES_BOOTSTRAP_CHECKS_DISABLE=true --memory="768m" --memory-swap="1g" -v sonarqube_data:/opt/sonarqube/data  -v sonarqube_logs:/opt/sonarqube/logs sonarqube:latest 
